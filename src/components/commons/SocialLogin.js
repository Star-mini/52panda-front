    ...
    <div className={styles.centerBox}>
      <div className={styles.greenBox}>
        ...
        <div className={styles.socialLoginButtons}>
          <img src={Google} alt="Google" className={styles.socialButton} onClick={() => handleSocialLogin('Google')} />
          <img src={Naver} alt="Naver" className={styles.socialButton} onClick={() => handleSocialLogin('Naver')} />
          <img src={Kakao} alt="Kakao" className={styles.socialButton} onClick={() => handleSocialLogin('Kakao')} />
        </div>
      </div>
    </div>
  );
