      ...
      <Form>
        ...
        <Form.Group as={Row} className="mb-4">
          ...
          <Col sm={5} className={styles['btn-inline-group']}>
            <ToggleButton type="checkbox" id="direct-check"
            ...
            <div className="vr" />
            <ToggleButton type="checkbox" id="parcel-check"
        ...
        <Form.Group as={Row} className="mb-4">
          <Col className={`me-3 ${styles['btn-inline-group']} ${styles['justif-content-end']}`} >
            <Button variant="success" className={styles['cancel-button']}>취소하기</Button>{" "}
            <Button variant="success" className={styles['submit-button']}> 등록하기 </Button>
          </Col>
        </Form.Group>
      </Form>
    </Container>
