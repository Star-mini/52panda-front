      ...
      <div className="content-box">
        ...
        <img src={profileLogo} alt="Profile Picture" />
          <div className="user-details">
            ...
            <span className="registration-date">등록일자: 2024/04/03 19:21:30</span>
          </div>
        </div>
        <div className="divider"></div>
        <p className="image-description">농사를 시작한 지 얼마 안됐어요. 어렵지만 흙, 씨앗, 물주기, 햇빛을 조금씩 알아가고 있어요.</p>
        <img src={exFarm} alt="A field of freshly tilled soil with a sunset in the background" />
      </div>
    </div>
  );
}
